...
public class AdminForgotPassword extends javax.swing.JFrame {
     ...
     */
    public AdminForgotPassword(String a) { 
        initComponents();
        setSize(500,515);
        setResizable(false);
        setTitle("Admin Forgot Password");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(90, 20, 310, 50);
        ...
        jPanel1.setBounds(390, 110, 500, 480);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(npass.isEmpty() || cpass.isEmpty()){
            ...
            ResultSet rs2 = DBLoader.executeQuery("select * from admin where email = '"+this.a+"'");
            try {
                if(rs2.next()){
